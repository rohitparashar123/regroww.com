...
const HeroSection = () => {
  return (
    <>
    <section id="home" className="ac a36 a2T a37 a38 sm:a39 lg:a1u[170px] lg:a1A[120px]">
            ...
            <div className="a1R a5 a6 a9">
                <div className="a4 a35 lg:a1S/2">
                    <div className="a1B a2J ae[530px] az lg:a3a lg:a2g lg:aW">
                        {/* <span className="wow fadeInUp a1E  logo a1j a16 a3b a1N[10px] a7 aE aF aH dark:an dark:a3c dark:aI"
                            data-wow-delay=".2s"> */}
                             {/* <span className="a3d  logo a3e a1W a1j a16"></span> Tailwind Template for Startups */}
                        {/* </span>  */}
                        <h1 className="wow fadeInUp a1I aE a1Y a1G dark:aI sm:a1L md:a1F[50px] md:a3f[60px]"
                           >
                            Digital Solutions for Your Business
                        </h1>
                        <p className="wow fadeInUp a2J aF aG" data-wow-delay=".4s">
                            We are a team of designers and developers that create high quality Hybrid Applications, Websites and Digital Solutions.
                        </p>
                        <div className="wow fadeInUp a5 a6 a9 am lg:as" data-wow-delay=".5s">
                            <a href="https://wa.me/+919717393189?text=I am intrested to collab with you" target="_blank" rel="noreferrer"
                            ...
                            {/* <a href="#about" className="aD a9 aS a1N[14px] aU aE aF a1t hover:aH dark:aI dark:hover:aH">
                                <span className="a2H">
                ...
                <div className="a4 a1v lg:a1S/2">
                    <div className="wow fadeInRight ac a3h a1B ah[560px] a4 ae[700px] lg:a3a" data-wow-delay=".3s" style={{height: '280px'}}>
                        <div className="a1 a2 a29 lg:a3i/12">
                            <Image src="./images/hero/Saly-10.png" alt="hero-image" className="img"/>
                        </div>
                        {/* <div className="a1 a3 a10 a2w">
                            <img src="./images/hero/image-1.jpg" alt="hero-image" />
                            <div
                                className="a1 a3j a3k a2D a2a a4 aT a28 a3l a16 a3b a3m[6px] dark:a2v dark:a3l dark:an dark:a3c">
                            </div>
                        </div>
        ...
        <div className="a1 a10 a3 a2D a2a a4 a2x a2y a3n dark:a3o"
