...
const Footer = () => {
  return (
    <>
    <footer className="wow fadeInUp a1P sm:a1Q lg:a1u[130px]" data-wow-delay=".2s">
        <div className="a1v xl:a1w">
            <div className="a1R a5 a6">
                <div className="a4 a1v sm:a1S/2 md:a1p/12 lg:a1T/12 xl:a1T/12">
                    <div className="a1U ae[330px]" style={{marginBottom: '2rem'}}>
                        <a href="index.html" className="a1V af logo">
                            Regroww
                        </a>
                        ...
                        {/* <div className="a5 a9 a12">
                            <a href="#" name="social-link" aria-label="social-link"
                ...
                <div className="a1S/2 a1v md:a1T/12 lg:a1T/12 xl:a1W/12">
                    <div className="a1U">
                        <h3 className="a1X aE a1Y a1K a1t dark:aI" style={{marginBottom: '1rem'}}>
                            Company
                        </h3>
                        <ul className="a1Z">
                            <li>
                ...
                <div className="a4 a1v sm:a1S/2 md:a1p/12 lg:a1T/12 xl:a1W/12">
                    <div className="a1U">
                        ...
                        <div className="a23">
                            <div>
                                <p className="aE aF aG">
                                    Toll Free Customer Care
                                </p>
                                <a href="tel:+(1) 123 456 7890" className="aE aF a1t hover:aH dark:aI dark:hover:aH">
                                    +91 9717393189
                                </a>
                            </div>
                            <div>
                                ...
                                <a href="mailto:support@regroww.com"
                                    className="aE aF a1t hover:aH dark:aI dark:hover:aH">
                                    <span className="__cf_email__"
                                        >support@regroww.com</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="a1U">
                        ...
                        <form className="ac">
                            ...
                            <button className="a1 a29 a2 a5 a2a a2b a9 am a2c aG dark:a1z[#1F2633]">
                                <svg width="20" height="20" viewBox="0 0 20 20" className="aL">
                                    <path
                ...
                <div className="a1R a5 a6 a2e md:a2f">
                    <div className="a4 a1v md:a1S/2 lg:a1W/3">
                        <div className="a1I a5 a9 am a12 a1x aV dark:a1z[#2E333D] md:a2g md:as md:a2h md:a2i">
                            ...
                            <a href="mailto:support@regroww.com" className="aE aF aG hover:aH">
                                Support
                            </a>
                        </div>
                    </div>
